...
- `2020_06_15_Kaggle_Challenge.html`: the html version of this report
- `util.py`: utility code to shorten this report

### How to read through this:

The `html` version of the report (hopefully) contains a streamlined narrative of this work -- it's a text/code hybrid that serves as a technical report. This report calls some utility functions from `util.py`, and so to get a better sense of what is going on, `util.py` is a good next read.